        ...
        return (
            <div className='App'>
                ...
                <section id='content'>
                    ...
                    <p id='text-learn-from'>我从网络中学习可视化.</p>

                    <p id='traveling'>我喜欢将他们结合到一起。</p>
            ...
            <div id="group">
              ...
              <img alt="" id="photo-h" src="./assets/images/83b278df.jpg" />
                ...
                <section id='programming'>
                    ...
                    <div id='nodes'>
                        <img alt='' id='node-scroll-button' src='images/arrow.svg' />
                ...
                <section id='design'>
                    <p id='text-design'>
                        我喜欢设计各种东西，从家居到平面、网页、视觉识别、用户体验等等。
                    </p>
                    <p id='text-dot-connecting'>
                        我不断尝试把自己的所想所爱结合在一起，创造些有意思的东西。
                    </p>
                </section>
